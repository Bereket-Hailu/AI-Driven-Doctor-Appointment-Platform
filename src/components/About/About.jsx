      ...
      <div className="container">
        <div className="flex justify-between gap-[50px] lg:gap-[130px] xl:gap-0 flex-col lg:flex-row">
            ...
            <div className="w-full lg:w-1/2 xl:w-[670px] order-1 lg:order-2">
                ...
                <p className="text__para">Welcome to our cutting-edge AI-Integrated Doctor Appointment Platform,
                   where innovation meets healthcare to provide an unparalleled experience for both patients and
